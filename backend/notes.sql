...
-- -----------------------------------------------------
-- Table `notes`.`user_has_note`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `notes`.`user_has_note` ;

CREATE TABLE IF NOT EXISTS `notes`.`user_has_note` (
...
CREATE INDEX `fk_user_has_notes_notes1_idx` ON `notes`.`user_has_note` (`notes_id` ASC) VISIBLE;

CREATE INDEX `fk_user_has_notes_user_idx` ON `notes`.`user_has_note` (`user_id` ASC) VISIBLE;
